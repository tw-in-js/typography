...
export default function App(): JSX.Element {
  return (
    <main class={tw`mx-auto px-10 py-10 sm:py-16 md:py-24 lg:py-32 xl:py-48`}>
      <article class={tw`prose prose-sm sm:prose lg:prose-lg xl:prose-2xl mx-auto`}>
        <p class={tw`lead`}>
          Until now, trying to style an article,, or blog post with Tailwind has been a tedious task
        ...
        <p>
          ...
          <em>actually</em>
          want, without any of the downsides of doing something stupid like disabling our base
          styles.
        </p>
        <p>
          It adds a new
        ...
        <pre>
          <code class="language-html">
            ...
            us&lt;/h1&gt; &lt;p&gt; For years parents have espoused the health benefits of eating
            garlic bread with cheese to their children, with the food earning such an iconic status
        ...
        <p>
          ...
          or something if they want to style their code blocks but it wouldn't hurt to make them
          look
          <em>okay</em>
...
`}
        ...
        <p>
          ...
          <code>&lt;p&gt;</code>
          tag unless there are multiple paragraphs in the list item. That means I have to worry
        ...
        <p>
          ...
          or
          <code>h6</code>
          in your content, Medium only supports two heading levels for a reason, you animals. I
          honestly considered using a<code>before</code>
